...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY AlwaysMarkz            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "MarkzGantengBuanget" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke AlwaysMarkz${NC}"
    echo -e "${YELLOW}TELEGRAM : @AlwaysMarkz${NC}"
    echo -e "${YELLOW}WHATSAPP : 628388049661${NC}"
    echo -e "${YELLOW}HARGA TOKEN : 15K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©AlwaysMarkz${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : AlwaysMarkz     ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : AlwaysMarkz     ${NC}"
